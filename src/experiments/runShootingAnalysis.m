...
function makeConvergenceFigure(stepSize, maxShooting, maxFiniteDifference, ...
    ...
    ax1 = nexttile;
    loglog(ax1, stepSize, maxShooting, 'o-', 'Color', '#354E68', ...
        'LineWidth', 1.5, 'MarkerFaceColor', '#354E68', ...
        'DisplayName', '打靶法 - 解析解');
    hold(ax1, 'on');
    loglog(ax1, stepSize, maxFiniteDifference, 's--', ...
        'Color', '#3B9D9A', 'LineWidth', 3, ...
        'MarkerFaceColor', '#3B9D9A', ...
        'DisplayName', '有限差分 - 解析解');
    loglog(ax1, stepSize, maxMethodDifference, 'd-.', ...
        'Color', '#9B7D40', 'LineWidth', 1.5, ...
        'MarkerFaceColor', '#9B7D40', ...

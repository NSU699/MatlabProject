...
function makeConvergenceFigure(h, maxError, rmsError, theoryOrder, titleText, fileName, outputFolder)
    ...
    loglog(ax, h, maxError, 'o-', 'LineWidth', 1.4, 'MarkerFaceColor', '#3B9D9A', ...
        'DisplayName', '最大绝对误差', 'Color', '#3B9D9A');
    loglog(ax, h, rmsError, 's--', 'LineWidth', 1.4, 'MarkerFaceColor', '#354E68', ...
        'DisplayName', 'RMS误差', 'Color', '#354E68');
